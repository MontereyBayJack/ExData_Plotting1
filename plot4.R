...
# upper right
plot(d$datetime,d$voltage,type="l",pch=0, 
...
legend("topright", pch=NA, bty="n", cex=0.75, lty=1, col=c("black","red","blue"), 
       legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
# lower right
plot(d$datetime,d$globalreactivepower,type="l",pch=0, 
